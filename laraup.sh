...
composer create-project --prefer-dist laravel/laravel=5.8.17 $NEW_PROJECT_PATH || die "New Laravel project couldn't be created, check the above message or your composer installation"
